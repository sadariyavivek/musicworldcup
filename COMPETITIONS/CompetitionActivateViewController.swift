//
//  CompetitionActivateViewController.swift
//  MusicAppWorld
//
...
class CompetitionActivateViewController: UIViewController {
    ...
    override func viewDidLoad() {
      ...
      roundView.layer.cornerRadius = 10.0
               ...
               btnCheckBox3.setImage(UIImage(named:"icon-3"), for: .selected)
    ...
    @IBAction func PREVIOUS_BUTTON(_ sender: Any) {
       ...
       @IBAction func ACTIVATE_BUTTON_CLICK(_ sender: Any) {
